...
run-configure-advanced-instance-script flags: (run-script 'ConfigureAdvancedLlamaInstance' flags '--sig "run(address,address,string)"' '$SCRIPT_DEPLOYER_ADDRESS <DEPLOYED_CORE> "advancedInstanceConfig.json"')
