...
contract LlamaAccount is ILlamaAccount, ERC721Holder, ERC1155Holder, Initializable {
  ...
  /// @dev WARNING: Be careful and intentional while assigning permissions to a policyholder that can create an action
  /// to call this function, especially while using the delegatecall functionality as it can lead to arbitrary code
  /// execution in the context of this Llama account.
