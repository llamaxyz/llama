...
///         The Batch Policy Functions section is public methods that (1) can be called directly as part of an action, and (2) are also used by Common Aggregate Calls methods
