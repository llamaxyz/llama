...
contract LlamaPolicyTokenURI {
    ...
    returns (string memory)
  {
    ...
    parts[4] =
      '" rx="140.048" ry="59.062" transform="rotate(-31.49 237.625 248.969)" /></g><circle cx="109.839" cy="147.893" r="22" fill="url(#f)" /><text fill="#fff" font-family="ui-monospace,Cascadia Mono,Menlo,Monaco,Segoe UI Mono,Roboto Mono,Oxygen Mono,Ubuntu Monospace,Source Code Pro,Droid Sans Mono,Fira Mono,Courier,monospace" font-size="38"><tspan x="32" y="459.581">';
    ...
    string memory output2 = string(abi.encodePacked(parts[9], parts[10], parts[11], parts[12], parts[13], parts[14]));
