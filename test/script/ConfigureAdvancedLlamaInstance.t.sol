...
contract ConfigureAdvancedLlamaInstanceTest is Test, DeployLlamaFactory, DeployLlamaInstance {
  LlamaCore instanceCore;
  ...
  function setUp() public virtual {
    ...
    for (uint256 i = 0; i < emittedEvents.length; i++) {
      ...
      if (eventSig == llamaInstanceCreatedSig) {
        ...
        //   uint256 chainId
        // )
        (instanceCore,,,) = abi.decode(_event.data, (LlamaCore, LlamaExecutor, address, uint256));
      }
    }
    mineBlock();
  }
...
contract RelativeStrategyRun is ConfigureAdvancedLlamaInstanceTest {
