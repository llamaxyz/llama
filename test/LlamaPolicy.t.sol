...
contract PolicyMetadata is LlamaPolicyTest {
  ...
  function test_ReturnsCorrectTokenURIWhenAddressHasLeadingZeroes(uint256 tokenIdWithLeadingZeroes) public {
    ...
    // than
    // 0x00000000000fffffffffffffffffffffffffffff
    // This guarantees that the fuzz output will have at least 11 leading zeroes
    bound(tokenIdWithLeadingZeroes, 0, 83_076_749_736_557_242_056_487_941_267_521_535);
