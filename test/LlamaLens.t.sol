  ...
  function test_ProperlyComputesAddress() public {
    ...
    address expected = address(
      lens.computeLlamaPolicyMetadataAddress(
        address(policyMetadataLogic), abi.encode(rootColor, rootLogo), address(rootPolicy)
      )
    );
    ...
    expected = address(
      lens.computeLlamaPolicyMetadataAddress(
        address(policyMetadataLogic), abi.encode(mpColor, mpLogo), address(mpPolicy)
      )
    );
