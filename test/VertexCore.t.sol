...
contract ExecuteActionCrosschain is VertexCoreTest {
  ...
  function setUp() public override {
    ...
    bytes4 relayCallsSelector = 0x5479f0d9; // relayCalls(bytes)
    ...
    bytes memory executionData = abi.encode(address(protocol));
    bytes memory data = abi.encode(137, address(executor), address(relayer), bytes(""));
  ...
  function test_ActionExecution() public {
    ...
    vm.expectEmit();
    emit ActionExecuted(0, address(this), mpStrategy1, actionCreatorAaron, bytes(""));
    mpCore.executeAction{value: 1e18}(0);

    bytes memory message =
      hex"";
